...
-- Dumping data for table msdsapp.sys_modul_menus: ~4 rows (approximately)
...
-- Dumping data for table msdsapp.sys_user_modul_roles: ~4 rows (approximately)
...
-- Dumping data for table msdsapp.user_logs: ~36 rows (approximately)
