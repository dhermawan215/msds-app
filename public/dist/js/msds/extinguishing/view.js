var Index = (function () {
    ...
    var handleDataTabelUser = function () {
        table = $("#tbl-" + pageName).DataTable({
            ...
            serverSide: true,
            ajax: {
                url: url + "/extinguishing-media/list",
                type: "POST",
                data: {
                    _token: csrf_token,
                },
        ...
        $("#btn-delete").click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: url + "/extinguishing-media/delete",
                        data: {
                            _token: csrf_token,
                            dValue: aSelected,
                        },
    ...
    var handleSubmit = function () {
        $("#form-add-" + pageName).submit(function (e) {
            ...
            if (confirm("is it correct?")) {
                $.ajax({
                    url: url + "/extinguishing-media/save",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
    ...
    var handleEdit = function () {
        $(document).on("click", ".btn-edit", function (e) {
            ...
            $.ajax({
                url: `${url}/extinguishing-media/edit`,
                type: "POST",
                data: {
                    _token: csrf_token,
                    de: dlVal,
                ...
                success: function (responses) {
                    ...
                    $("#notes-edit").val(dataResponse.notes);
    ...
    var handleUpdate = function (dlVal) {
        $("#form-edit-" + pageName).submit(function (e) {
            ...
            if (confirm("is it correct?")) {
                $.ajax({
                    url: url + "/extinguishing-media/update",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
