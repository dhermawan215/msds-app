var Index = (function () {
    ...
    var table;
    var aSelected = [];
    const pageName = "spesific-hazard";
        ...
        $("#btn-delete").click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: url + "/spesific-hazard/delete",
                        data: {
                            _token: csrf_token,
                            dValue: aSelected,
                        },
    ...
    var handleUpdate = function (dlVal) {
        $("#form-edit-" + pageName).submit(function (e) {
            ...
            if (confirm("is it correct?")) {
                $.ajax({
                    url: url + "/spesific-hazard/update",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
