var Index = (function () {
    ...
    var handleDataTable = function () {
        table = $("#tbl-" + moduleName).DataTable({
            ...
            serverSide: true,
            ajax: {
                url: url + "/admin/customer/customer-detail/list",
                type: "POST",
                data: {
                    _token: csrf_token,
        ...
        $("#btn-delete").click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: url + "/admin/customer/customer-detail/delete",
                        data: {
                            _token: csrf_token,
                            dValue: aSelected,
                        },
    ...
    var handleAdd = function () {
        $("#form-add-" + moduleName).submit(function (e) {
            ...
            if (confirm("Are you sure?")) {
                $.ajax({
                    url: `${url}/admin/customer/customer-detail/save`,
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
    ...
    var handleUpdate = function (idEdit) {
        $("#form-edit-" + moduleName).submit(function (e) {
            ...
            if (confirm("Are you sure?")) {
                $.ajax({
                    url: `${url}/admin/customer/customer-detail/update`,
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
