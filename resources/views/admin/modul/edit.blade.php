                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="javascript:;" class="form-horizontal" method="POST" id="formEditModule">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" name="form_value" id="form-value" value="{{ base64_encode($moduleData->id) }}">
                            <div class="form-group row">
                                <label for="name">Module Name</label>
                                <input type="text" name="name" id="moduleName" class="form-control" placeholder="module name" value="{{ $moduleData->name }}">
                            </div>

                            <div class="form-group row">
                                <label for="email">Route Name</label>
                                <input type="text" name="route_name" id="routeName" class="form-control" placeholder="route name" value="{{ $moduleData->route_name }}">
                            </div>
                            <div class="form-group row">
                                <label for="link">Link</label>
                                <input type="text" name="link_path" id="link" class="form-control" placeholder="link/url" value="{{ $moduleData->link_path }}">
                            </div>
                            <div class="form-group row">
                                <label for="description">Description</label>
                                <input type="text" name="description" id="description" class="form-control" placeholder="description" value="{{ $moduleData->description }}">
                            </div>
                            <div class="form-group row">
