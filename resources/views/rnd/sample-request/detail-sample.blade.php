                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="m-1">
                                <div class="mb-2">
                                    <a href="{{ route('rnd_sample_request') }}" class="btn btn-sm btn-outline-secondary"><i
                                ...
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="requestor_note" id="requestor-note" class="form-control"
                                            value="{{ $sampleRequestData->requestor_note }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="requestor_note" id="requestor-note" class="form-control"
                                            value="{{ $sampleRequestData->sample_pic_note }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="requestor_note" id="requestor-note" class="form-control"
                                            value="{{ $sampleRequestData->rnd_note }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col">
