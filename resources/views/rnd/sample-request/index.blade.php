            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Sample Creator (Rnd/WH) - Sample Request Dashboard</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-titile">Sample Creator (Rnd/WH) - Sample Request Dashboard</h3>
                        </div>
                        <div class="card-body">
                            <div class="m-1">
                                <div class="mb-2">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 col-lg-6 col-sm-12">
                                        ...
                                        <select name="status_sample" id="status-sample" class="form-control">
                                            <option selected value="1">Confirm</option>
                            ...
                            <div class="m-1">
                                <hr>
                                <table class="table table-bordered" id="tbl-sample-rnd" style="width: 100%;">
...
@push('custom_js')
    ...
    <script src="{{ asset('dist/js/rnd/sample-request/view.min.js?q=') . time() }}"></script>
@endpush
