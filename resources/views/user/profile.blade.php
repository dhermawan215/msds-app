                ...
                <div class="card">
                    ...
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link logs-link" href="#timeline" data-toggle="tab">Logs</a>
                        ...
                        <div class="tab-content">
                                    ...
                                    <form id="formChangePwd" action="javascript:;" class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-2 col-form-label">Password
                                                Confirmation</label>
                                            <div class="col-sm-10">
                                                <input type="password" name="confirm_password" class="form-control" id="confirmPassword" placeholder="confirmation new password">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                            ...
                            <div class="tab-pane" id="settings">
                                <form class="form-horizontal" method="POST" id="formUpdateUserData">
                                    ...
                                    <div class="form-group row">
                                        <div class="offset-sm-2 col-sm-10">
                                            <button type="submit" id="btnUserUpdate" class="btn btn-danger">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
