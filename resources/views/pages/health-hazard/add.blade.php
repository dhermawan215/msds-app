                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-titile">Add Health Hazard</h3>
                        </div>
                        <div class="card-body">
                            <form action="javascript:;" method="post" id="form-add-health-hazard">
                                @csrf
...
@endsection
@push('custom_js')
    <script src="{{ asset('dist/js/health-hazard/add.min.js?q=') . time() }}"></script>
@endpush
