            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">Response Precautionary Statement</li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-titile">Edit Response Precautionary Statement</h3>
                        </div>
                        <div class="card-body">
                            <form action="javascript:;" method="post" id="form-edit-response">
                                @csrf
                                @method('PATCH')
...
@endsection
@push('custom_js')
    <script src="{{ asset('dist/js/precautionary/response/edit.min.js?q=') . time() }}"></script>
@endpush
