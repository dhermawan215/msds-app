            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Environmental Hazard</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-titile">Environmental Hazard</h3>
                        </div>
                        <div class="card-body">
                            <div class="m-1">
                                <div class="mb-2">
                                    ...
                                    <a href="{{ route('environmental_hazard.add') }}" id="add-data"
                            ...
                            <div class="m-1">
                                <table class="table table-bordered" id="tbl-environmental-hazard" style="width: 100%;">
                                    <thead>
                                        <tr>
...
@push('custom_js')
    ...
    <script src="{{ asset('dist/js/environmental/view.min.js?q=') . time() }}"></script>
@endpush
