                            ...
                            <div class="m-1">
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="sample_source" id="sample-source" class="form-control" disabled>
                                            <option selected value="{{ $sample->sample_source_id }}">
                                                {{ $sample->sampleSource ? $sample->sampleSource->name : 'empty data' }}
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $sampleCustomer ? $sampleCustomer->sampleCustomer->customer_name : 'empty data' }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $sampleCustomer ? $sampleCustomer->customer_pic : 'empty data' }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $sampleCustomer ? $sampleCustomer->delivery_address : 'empty data' }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $sampleCustomer ? $sampleCustomer->customer_note : 'empty data' }}"
                                            readonly>
                                    </div>
                                </div>
