...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Safety phrases</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-titile">Safety phrases</h3>
                        </div>
                        <div class="card-body">
                            <div class="m-1">
                                <div class="mb-2">
                                    ...
                                    <button id="btn-add" class="btn btn-primary btn-sm disabled" data-toggle="modal"
                                        data-target="#modal-add-safety-phrases"><i class="fa fa-plus"
                                            aria-hidden="true"></i>
                                        Add</button>
                            ...
                            <div class="m-1">
                                <table class="table table-bordered" id="tbl-safety-phrases" style="width: 100%;">
                                    <thead>
                                        <tr>
    ...
    <div class="modal fade" id="modal-add-safety-phrases">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Add safety phrases</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="javascript:;" method="post" id="form-add-safety-phrases">
                        @csrf
                        <div class="form-group row">
                            <label for="name">Code</label>
                            <input type="text" name="code" id="code" class="form-control" placeholder="Note">
                        </div>
                        <div class="form-group row">
    ...
    <div class="modal fade" id="modal-edit-safety-phrases">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Edit safety phrases</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="javascript:;" method="post" id="form-edit-safety-phrases">
                        @csrf
                        <div class="form-group row">
                            <label for="name">Code</label>
...
@push('custom_js')
    ...
    <script src="{{ asset('dist/js/msds/safety-phrases/view.min.js?q=') . time() }}"></script>
@endpush
