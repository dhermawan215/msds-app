...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Eye contact</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-titile">Eye contact</h3>
                        </div>
                        <div class="card-body">
                            <div class="m-1">
                                <div class="mb-2">
                                    ...
                                    <button id="btn-add" class="btn btn-primary btn-sm disabled" data-toggle="modal"
                                        data-target="#modal-add-eye-contact"><i class="fa fa-plus" aria-hidden="true"></i>
                                        Add</button>
                            ...
                            <div class="m-1">
                                <table class="table table-bordered" id="tbl-eye-contact" style="width: 100%;">
                                    <thead>
                                        <tr>
    ...
    <div class="modal fade" id="modal-add-eye-contact">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Add eye contact</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="javascript:;" method="post" id="form-add-eye-contact">
                        @csrf
    ...
    <div class="modal fade" id="modal-edit-eye-contact">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Edit eye contact</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="javascript:;" method="post" id="form-edit-eye-contact">
                        @csrf
                        <div class="form-group row">
                            <label for="code">Description</label>
...
@push('custom_js')
    ...
    <script src="{{ asset('dist/js/msds/eye-contact/view.min.js?q=') . time() }}"></script>
@endpush
